...
<div class="container">
  <!-- Brand/logo -->
  <a class="navbar-brand" href="/demo06/">HOME</a>
  ...
  <ul class="navbar-nav mr-auto">
    	...
    	<li class="nav-item"><a class="nav-link" href="/file2/insert">FileInsert2(properties)</a></li>
		...
		<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link" href="/user/list">회원리스트</a></li>
				</c:if>
				<li class="nav-item"><a class="nav-link" href="/userUpdate">회원변경</a></li>
